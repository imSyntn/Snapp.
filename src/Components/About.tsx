...
const About = () => {
  return (
    <div className='About'>
      ...
      <ul>
        <li><b><i>Discover:</i></b> Browse through an extensive gallery of beautiful photos sourced from Unsplash, an acclaimed community of photographers.</li>
        <li><b><i>Share:</i></b> Easily share your favorite images with friends and family with just a few clicks. Snapp makes image sharing quick and intuitive.</li>
        <li><b><i>Organize:</i></b> Save your favorite photos to collections, allowing you to keep your inspirations and interests neatly organized and easily accessible.</li>
      </ul>
      <h2>Why Snapp?</h2>
      ...
      <h4>Join us on this visual journey and let Snapp be your go-to platform for all things image-related. Explore the beauty of the world through the lens of talented photographers and make every snapp count!</h4>
    </div>
  )
}
